 ...
 */
public class frmVenal extends javax.swing.JFrame {
    /**
    ...
    public frmVenal(view.frmTela tu,Usuario u) throws Exception {
    ...
    public void buscaCertidao() {
        ...
        try{
            cert= new VenalBD().listaTabela(txtPesquisa.getText(),cbxConsulta.getSelectedIndex()+1);
    ...
    public void imprimirCertidao1(){
            contImprimir = 1;
              ...
              ///alterar endereco desta pagina 
                 String arquivoJasper = "C:\\prjVenalUrbano\\src\\certidao\\certidaoValorVenal.jasper";                  
                    try {
     ...
     public void imprimirCertidao2(){
            contImprimir = 1;
               ...
               //JasperPrint print = JasperFillManager.fillReport(report, null, new JRBeanCollectionDataSource(listaString)); 
                 ...
                 HashMap map = new HashMap();
              ///alterar endereco desta pagina 
                 String arquivoJasper = "C:\\prjVenalUrbano\\src\\certidao\\certidaoValorVenal3.jasper";                  
                    try {
                            cert = JasperFillManager.fillReport(arquivoJasper, null,new JRBeanCollectionDataSource(listaString));
                            JasperViewer.viewReport(cert, false);
                        } catch (JRException ex) {
...
public void buscaValorVenal() {
            try {
                lista = new VenalBD().listaCertidao1(telaUrbano.getExercicio());              
            } catch (SQLException ex) {
            }
    }
...
public String getData()  {  
    ...
    private void initComponents() {
        ...
        setTitle("CERTIDÃO DE VALOR VENAL");
