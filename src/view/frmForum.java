 ...
 */
public class frmForum extends javax.swing.JFrame {

   /**
     * Creates new form frmVenal
     */
    List<Forum> lista;
    ...
    ForumString certidaoString = new ForumString();
    ValorExtenso extenso = new ValorExtenso();
    String nome=" ",dataSistema=" ";
    int op=0;
    int contImprimir = 0;
    Usuario us = null;
    List<Forum> cert = null;

    public frmForum(view.frmTela tu, model.Usuario u) {
        telaUrbano = tu;
        us = u;
    ...
    public void retornaDados(){
         ...
         try {
            ...
            txtRua.setText(String.valueOf(cert.get(indice).getRua()));
    ...
    public void buscaCertidao() {
        ...
        try{
            cert= new ForumBD().listaTabela(txtPesquisa.getText(),cbxConsulta.getSelectedIndex()+1);
...
public boolean isValidDate(String inDate) {
    ...
    public void imprimirCertidao1(){
              ...
              ///alterar endereco desta pagina 
                 String arquivoJasper = "C:\\prjValorVenal\\src\\view.jasperreports\\certidaoForum.jasper";                  
                    try {
     ...
     public void imprimirCertidao2(){
               ...
               //JasperPrint print = JasperFillManager.fillReport(report, null, new JRBeanCollectionDataSource(listaString)); 
                 ...
                 HashMap map = new HashMap();
              ///alterar endereco desta pagina 
                 String arquivoJasper = "C:\\prjValorVenal\\src\\view.jasperreports\\certidaoForum2.jasper";                  
                    try {
                            cert = JasperFillManager.fillReport(arquivoJasper, null,new JRBeanCollectionDataSource(listaString));
                            JasperViewer.viewReport(cert, false);
                        } catch (JRException ex) {
...
public void buscaValorVenal() {
            try {
                lista = new ForumBD().listaCertidao1(telaUrbano.getExercicio());              
            } catch (SQLException ex) {
            }
    }
...
public String getData()  {  
    ...
    private void initComponents() {
        ...
        setTitle("CERTIDÃO PARA O FÓRUM");
            ...
            public void windowClosed(java.awt.event.WindowEvent evt) {
				if(contImprimir==1){
					 try {
						 ...
						 Logger.getLogger(frmForum.class.getName()).log(Level.SEVERE, null, ex);
					 }
				}else{
						telaUrbano.setEnabled(true);
						telaUrbano.setVisible(true);
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtValorVenal, javax.swing.GroupLayout.PREFERRED_SIZE, 360, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtConstrucao, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtTerreno, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtProcesso, javax.swing.GroupLayout.PREFERRED_SIZE, 304, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
        );
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        Forum certidao = new Forum();
        ForumBD certidaoBD = new ForumBD();
        ...
        if(txtBairro.getText().equals("")){
            ...
            if(txtData.getText().equals("  /  /    ") || validata(txtData.getText())==false){
                ...
                certidaoString.cadastrar(   String.valueOf(lista.get(0).getProtocolo()),
                    lista.get(0).getProcesso(),
                    lista.get(0).getAssunto(),
